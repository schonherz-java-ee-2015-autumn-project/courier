...
insert into address (address, deadline,  payment, status) values ("Debrecen, Piac utca 68", '2015-12-07 14:36:12',  'Készpénz', 'Kiszállítás alatt');
insert into address (address, deadline,  payment, status) values ("Debrecen, Böszörményi út 68", '2015-12-07 14:36:12',  'Készpénz', 'Kiszállítás alatt');
...
insert into cargo (status, restaurant_id) values ("Status", 1);
...
insert into cargo (status, restaurant_id) values ("Status", 2);
...
insert into address (address, deadline,  payment, status) values ("Debrecen, Füredi út 95", '2015-12-07 14:36:12',  'Készpénz', 'Kiszállítás alatt');
